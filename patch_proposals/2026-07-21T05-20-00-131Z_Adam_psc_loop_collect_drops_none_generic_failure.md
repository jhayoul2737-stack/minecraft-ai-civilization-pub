...
- bot: Adam
- time: 2026-07-21T05:20:00.133Z

## Analysis
Action collect_drops:none repeatedly failed with reason generic_failure. Examples: 근처에 회수할 드랍이 없다. / 근처에 회수할 드랍이 없다. / 근처에 회수할 드랍이 없다.
